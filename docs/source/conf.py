...
# sof_models_churn documentation build
...
from sof_models_churn import __version__ as release

# -- Project information -----------------------------------------------------

project = "sof_models_churn"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "sof_models_churndoc"
...
latex_documents = [
    (
        master_doc,
        "sof_models_churn.tex",
        "sof_models_churn Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "sof_models_churn",
        "Project sof_models_churn codebase.",
        "Data-Science",
    )
]
